    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            if user.status == "kicked":
                await c.send_message(
                    chat_id=m.chat.id,
                    text="Sorry Sir, You are Banned to use me. Contact my [deve loper](https://t.me/nopostinthischannel).",
                    parse_mode="markdown",
            ...
            await c.send_message(
                chat_id=m.chat.id,
                text="**Please Join My Updates Channel to use this Bot!**\n\nDue to my rules and regulations, Only Channel Subscribers can use the Bot!",
            ...
            await c.send_message(
                chat_id=m.chat.id,
                text="Something went Wrong. Contact my [Devel oper](https://t.me/nopostinthischannel).",
                parse_mode="markdown",
                disable_web_page_preview=True)
            return
    try:
...
async def channel_receive_handler(bot, broadcast):
    ...
    try:
        ...
        await log_msg.reply_text(
            text=f'**Channel Name:** `{broadcast.chat.title}`\n**Channel ID:** `{broadcast.chat.id}`\n**Link:** https://t.me/AH_File2Link_Bot?start=AbirHasan2005_{log_msg.message_id}',
            quote=True,
            parse_mode="Markdown",
        )
                ...
                [
                    [
                        InlineKeyboardButton(
                            ...
                            url=f'https://t.me/pyrobbbot_Bot?start=100{log_msg.message_id}',
                        )
                    ]
                ]
            ),
